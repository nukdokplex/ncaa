{
  opts = {
    ...
    softtabstop = 2; # Controls how many spaces a tab "feels like" when editing (mixing tabs & spaces).
    shiftwidth = 2; # Determines the number of spaces used for auto-indentation and >>/<< shifting.
