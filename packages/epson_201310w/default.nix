...
{
  epson_201310w = stdenv.mkDerivation (
    lib.fix (self: {
      pname = "epson_201310w";
      version = "1.0.1";
      ...
      src = fetchurl {
        urls = [
          "https://download3.ebz.epson.net/dsc/f/03/00/15/64/77/6f825c323a9f4b8429e3f9f0f4e9c50b1b15f583/epson-inkjet-printer-201310w-${self.version}-1.src.rpm"
          "https://web.archive.org/web/https://download3.ebz.epson.net/dsc/f/03/00/15/64/77/6f825c323a9f4b8429e3f9f0f4e9c50b1b15f583/epson-inkjet-printer-201310w-${self.version}-1.src.rpm"
        ];
